...
void initTILE0(uint32_t base)
{
    ...
    //
    //  Equation for Output Look-Up Table Block 4 for TILE0: i0&i1
    //
    CLB_configOutputLUT(base, CLB_OUT4, TILE0_CFG_OUTLUT_4);

    //
    //  Equation for Output Look-Up Table Block 5 for TILE0: ~i0 | i1
    //
    ...
    //
    //  State 0 output equation for Finite State Machine 0 for TILE0: (~s0&e0)|(s0&~e1)
    //  State 0 output equation for Finite State Machine 1 for TILE0: (s0&~e0)|(~s0&e1)
    ...
    //
    //  User Description for the High Level Controller for TILE0
    /*
    ...
    */
    ...
    CLB_writeFIFOs(base, TILE0_HLC_initFIFOData);
...
void initTILE1(uint32_t base)
{
    ...
    //
    //  Equation for Output Look-Up Table Block 5 for TILE1: i0 & i1
    //
    ...
    */
    ...
    CLB_writeFIFOs(base, TILE1_HLC_initFIFOData);
